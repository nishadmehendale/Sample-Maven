            ...
            steps { 
                    ...
                    withCredentials([
                        [$class: 'UsernamePasswordMultiBinding', credentialsId: 'e1d83a1e-cddb-41af-840b-2f46d44c41dd', usernameVariable: 'GIT_USER', passwordVariable: 'GIT_PASS'],
                                    ...
                                    git push https://${GIT_USER}:${GIT_PASS}@cfsintna@bitbucket.org/cfsintnadev/app-dev-flights-ubuntu-ws.git --force refs/tags/${gitTagLatest()}.${env.BUILD_NUMBER}:refs/tags/${gitTagLatest()}.${env.BUILD_NUMBER}
                                    )"""
                                }
