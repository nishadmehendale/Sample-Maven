         ...
         stage('deploy app'){
            steps { 
                script {
                    ...
                    sh "ssh -o StrictHostKeyChecking=no -l ec2-54-172-22-145.compute-1.amazonaws.com ./download_artifact.sh ${gitTagLatest()}.${env.BUILD_NUMBER}-SNAPSHOT ec2-52-54-222-132.compute-1.amazonaws.com"
                }
           }
       }
